...
increment_tick:
    reg_assign esi, tick_counter ; store tick_counter pointer
    reg_assign edi, frontal_time ; store frontal_tick pointer
    ...
    cmp tick_counter, 0 ; check to see if we are on the frontal tick
    jne .inc

    call time ; get the current time and set it as the frontal tick
